...
At the end of your response, wrap the suitable person's name in <SELECTED> name </SELECTED>. Make sure the suitable person is not the requestor. You must pick one person ONLY. No fewer, no more.
...
Based on the above information, which person would be the best match for this request? Explain your reasoning. Make sure to end the response with the person's name in <SELECTED> ... </SELECTED>, and do not match the requestor with him or herself."""
