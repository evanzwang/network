...
At the end of your response, wrap the suitable person's name in <SELECTED> name </SELECTED>. Make sure the suitable person is not the requestor. You must output one person ONLY. No fewer, no more.
